...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "UPDATE dbo.penyerahan_kebenaran_data
            SET status_pengumpulan_penyerahan_kebenaran_data = ?, keterangan_pengumpulan_penyerahan_kebenaran_data = ?
            WHERE nim = ?";
...
function redirectToUpload($nim = null) {
    ...
    $previousUrl = isset($_SERVER['HTTP_REFERER']) ? $_SERVER['HTTP_REFERER'] : '../kebenarandata.php';
