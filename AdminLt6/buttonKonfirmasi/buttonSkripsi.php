...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['nim'])) {
    ...
    $sql = "UPDATE dbo.penyerahan_skripsi SET status_pengumpulan_penyerahan_skripsi = ? WHERE NIM = ?";
    ...
    if ($status === 'terkonfirmasi'){
        $sqlConfirm ="UPDATE dbo.penyerahan_skripsi SET keterangan_pengumpulan_penyerahan_skripsi = 'Skripsi Lengkap' WHERE NIM = ?";
