...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active" id="nav-kompen">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Data Verifikasi Bebas Kompen</h1>
                            ...
                            <table class="table table-striped table-bordered" id="dataTable" width="100%"
                                ...
                                <tbody>
                                    ...
                                    try {
                                        ...
                                        $sql = "SELECT m.nim, m.nama_mahasiswa, pk.status_pengumpulan_bebas_kompen AS status
                                                FROM dbo.mahasiswa m
                                                JOIN dbo.bebas_kompen pk ON m.nim = pk.nim
                                                ORDER BY 
                                                    CASE 
                                                        WHEN pk.status_pengumpulan_bebas_kompen = 'pending' THEN 1
                                                        WHEN pk.status_pengumpulan_bebas_kompen = 'ditolak' THEN 2
                                                        WHEN pk.status_pengumpulan_bebas_kompen = 'belum upload' THEN 3
                                                        WHEN pk.status_pengumpulan_bebas_kompen = 'terverifikasi' THEN 4
                                                        ELSE 5
                                                    END";
                                                ...
                                                <td>
                                                    ...
                                                    <?php elseif (strtolower($row['status']) === 'terverifikasi'): ?>
                                                        <button class="btn btn-info btn-sm edit-data"
                                                            ...
                                                            data-nama-berkas="<?= $row['nim'] . "_kompen.pdf" ?>"
                                                            data-pdf="../Documents/uploads/kompen/<?= $row['nim'] ?>_kompen.pdf"
                ...
                <div class="modal-body">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form id="verifikasiForm" action="buttonKonfirmasi/buttonKompen.php" method="POST">
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function () {
            ...
            buttons.forEach(button => {
                button.addEventListener("click", function () {
                    const nim = this.getAttribute("data-nim");
                    const pdfUrl = `../Documents/uploads/kompen/${nim}_kompen.pdf`;

                    // Update isi modal
                    document.getElementById('nim').value = nim;
                    document.getElementById('namaBerkas').value = `${nim}_kompen.pdf`;
