...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active" id="nav-pkl">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Data Verifikasi Laporan PKL</h1>
                                                ...
                                                <td>
                                                    ...
                                                    <?php elseif (strtolower($row['status']) === 'terverifikasi'): ?>
                                                        <button class="btn btn-info btn-sm edit-data"
                                                            ...
                                                            data-nama-berkas="<?= $row['nim'] . "_penyerahan_pkl.pdf" ?>"
                                                            data-pdf="../Documents/uploads/pkl/<?= $row['nim'] ?>_penyerahan_pkl.pdf"
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function () {
            ...
            buttons.forEach(button => {
                button.addEventListener("click", function () {
                    const nim = this.getAttribute("data-nim");
                    const pdfUrl = `../Documents/uploads/penyerahan_pkl/${nim}_penyerahan_pkl.pdf`;

                    // Update isi modal
                    document.getElementById('nim').value = nim;
                    document.getElementById('namaBerkas').value = `${nim}_penyerahan_pkl.pdf`;
