...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "UPDATE dbo.aplikasi
            SET status_pengumpulan_aplikasi = ?, keterangan_pengumpulan_aplikasi = ?
            WHERE nim = ?";
...
function redirectToUpload($nim = null) {
    ...
    $previousUrl = isset($_SERVER['HTTP_REFERER']) ? $_SERVER['HTTP_REFERER'] : '../program_mahasiswa.php';
