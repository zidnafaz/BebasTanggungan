...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active" id="nav-publikasi_jurnal">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Data Verifikasi Publikasi Jurnal</h1>
                            ...
                            <table class="table table-striped table-bordered" id="dataTable" width="100%"
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th>Status Upload Publikasi Jurnal</th>
                                        <th>Action</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    try {
                                        ...
                                        $sql = "SELECT m.nim, m.nama_mahasiswa, pk.status_pengumpulan_publikasi_jurnal AS status
                                                FROM dbo.mahasiswa m
                                                JOIN dbo.publikasi_jurnal pk ON m.nim = pk.nim
                                                ORDER BY 
                                                    CASE 
                                                        WHEN pk.status_pengumpulan_publikasi_jurnal = 'pending' THEN 1
                                                        WHEN pk.status_pengumpulan_publikasi_jurnal = 'ditolak' THEN 2
                                                        WHEN pk.status_pengumpulan_publikasi_jurnal = 'belum upload' THEN 3
                                                        WHEN pk.status_pengumpulan_publikasi_jurnal = 'terverifikasi' THEN 4
                                                        ELSE 5
                                                    END";
                ...
                <div class="modal-body">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form id="verifikasiForm" action="buttonKonfirmasi/buttonpublikasi_jurnal.php"
                                method="POST">
