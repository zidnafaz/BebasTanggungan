...
<body id="page-top">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">DATA LAPORAN UPLOAD PUBLIKASI JURNAL</h1>
    ...
    $(document).ready(function() {
        ...
        $('#statusFilter').on('change', function() {
            var status = $(this).val();
            table.column(2).search(status).draw(); // Kolom ke-2 adalah Status publikasi_jurnal
        });
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        buttons.forEach(button => {
            button.addEventListener("click", function() {
                const nim = this.getAttribute("data-nim");
                const pdfUrl =
                    `../Documents/uploads/publikasi_jurnal/${nim}_publikasi_jurnal.pdf`;
