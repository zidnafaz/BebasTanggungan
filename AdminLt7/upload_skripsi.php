                            ...
                            <table class="table table-striped table-bordered" id="dataTable" width="100%"
                                ...
                                <tbody>
                                    ...
                                    try {
                                        ...
                                        $sql = "SELECT m.nim, m.nama_mahasiswa, pk.status_pengumpulan_skripsi AS status
                                        ...
                                        $sql .= " ORDER BY 
                                                    CASE 
                                                        WHEN pk.status_pengumpulan_skripsi = 'pending' THEN 1
                                                        WHEN pk.status_pengumpulan_skripsi = 'ditolak' THEN 2
                                                        WHEN pk.status_pengumpulan_skripsi = 'belum upload' THEN 3
                                                        WHEN pk.status_pengumpulan_skripsi = 'terverifikasi' THEN 4
                                                        ELSE 5
                                                    END";
