                                                ...
                                                <td>
                                                    ...
                                                    <?php elseif (strtolower($row['status']) === 'terverifikasi'): ?>
                                                        <button class="btn btn-info btn-sm edit-data"
                                                            ...
                                                            data-nama-berkas="<?= $row['nim'] . "_bebas_pinjam_buku_perpustakaan.pdf" ?>"
                                                            data-pdf="../Documents/uploads/bebas_pinjam_buku_perpustakaan/<?= $row['nim'] ?>_bebas_pinjam_buku_perpustakaan.pdf"
                ...
                <div class="modal-body">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form id="verifikasiForm" action="buttonKonfirmasi/buttonBebasPinjaman.php" method="POST">
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function () {
            ...
            buttons.forEach(button => {
                button.addEventListener("click", function () {
                    const nim = this.getAttribute("data-nim");
                    const pdfUrl = `../Documents/uploads/bebas_pinjam_buku_perpustakaan/${nim}_bebas_pinjam_buku_perpustakaan.pdf`;
