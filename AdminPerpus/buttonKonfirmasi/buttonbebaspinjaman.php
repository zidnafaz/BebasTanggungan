...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "UPDATE dbo.bebas_pinjam_buku_perpustakaan
            SET status_pengumpulan_bebas_pinjam_buku_perpustakaan = ?, keterangan_pengumpulan_bebas_pinjam_buku_perpustakaan = ?
            WHERE nim = ?";
...
function redirectToUpload($nim = null) {
    ...
    $previousUrl = isset($_SERVER['HTTP_REFERER']) ? $_SERVER['HTTP_REFERER'] : '../bebas_pinjaman.php';
