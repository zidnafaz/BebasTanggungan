...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "UPDATE dbo.tugas_akhir_softcopy
            SET status_pengumpulan_tugas_akhir_softcopy = ?, keterangan_pengumpulan_tugas_akhir_softcopy = ?
            WHERE nim = ?";
...
function redirectToUpload($nim = null) {
    ...
    $previousUrl = isset($_SERVER['HTTP_REFERER']) ? $_SERVER['HTTP_REFERER'] : '../softcopy.php';
