        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">DATA LAPORAN UPLOAD HASIL KUISIONER</h1>
                            ...
                            <table class="table table-striped table-bordered" id="dataTable" width="100%"
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th>Status Upload Hasil Kuisioner</th>
                                        <th>Action</th>
                                    </tr>
                                </thead>
                                <tbody>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('#statusFilter').on('change', function () {
                var status = $(this).val();
                table.column(2).search(status).draw();  // Kolom ke-2 adalah Status hasil_kuisioner
            });
