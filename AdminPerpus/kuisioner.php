...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active" id="nav-kuisioner">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Data Verifikasi Bukti Pengisian Kuisioner</h1>
                            ...
                            <table class="table table-striped table-bordered" id="dataTable" width="100%"
                                ...
                                <tbody>
                                    ...
                                    try {
                                        ...
                                        $sql = "SELECT m.nim, m.nama_mahasiswa, pk.status_pengumpulan_hasil_kuisioner AS status
                                                FROM dbo.mahasiswa m
                                                JOIN dbo.hasil_kuisioner pk ON m.nim = pk.nim";
                                        ...
                                        $sql .= " ORDER BY 
                                                    CASE 
                                                        WHEN pk.status_pengumpulan_hasil_kuisioner = 'pending' THEN 1
                                                        WHEN pk.status_pengumpulan_hasil_kuisioner = 'ditolak' THEN 2
                                                        WHEN pk.status_pengumpulan_hasil_kuisioner = 'belum upload' THEN 3
                                                        WHEN pk.status_pengumpulan_hasil_kuisioner = 'terverifikasi' THEN 4
                                                        ELSE 5
                                                    END";
                                                ...
                                                <td>
                                                    ...
                                                    <?php elseif (strtolower($row['status']) === 'terverifikasi'): ?>
                                                        <button class="btn btn-info btn-sm edit-data"
                                                            ...
                                                            data-nama-berkas="<?= $row['nim'] . "_hasil_kuisioner.pdf" ?>"
                                                            data-pdf="../Documents/uploads/hasil_kuisioner/<?= $row['nim'] ?>_hasil_kuisioner.pdf"
                ...
                <div class="modal-body">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form id="verifikasiForm" action="buttonKonfirmasi/buttonkuisioner.php" method="POST">
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function () {
            ...
            buttons.forEach(button => {
                button.addEventListener("click", function () {
                    const nim = this.getAttribute("data-nim");
                    const pdfUrl = `../Documents/uploads/hasil_kuisioner/${nim}_hasil_kuisioner.pdf`;

                    // Update isi modal
                    document.getElementById('nim').value = nim;
                    document.getElementById('namaBerkas').value = `${nim}_hasil_kuisioner.pdf`;
