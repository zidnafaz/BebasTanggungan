...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active" id="nav-tugas_akhir">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Data Verifikasi Bukti Upload Softcopy</h1>
                                    ...
                                    try {
                                        ...
                                        $sql .= " ORDER BY 
                                                    CASE 
                                                        ...
                                                        WHEN pk.status_pengumpulan_tugas_akhir_softcopy = 'belum upload' THEN 3
                                                        WHEN pk.status_pengumpulan_tugas_akhir_softcopy = 'terverifikasi' THEN 4
                                                        ELSE 5
                                                    END";
                                                ...
                                                <td>
                                                    ...
                                                    <?php elseif (strtolower($row['status']) === 'terverifikasi'): ?>
                                                        <button class="btn btn-info btn-sm edit-data"
                                                            ...
                                                            data-nama-berkas="<?= $row['nim'] . "_tugas_akhir_softcopy.pdf" ?>"
                                                            data-pdf="../Documents/uploads/tugas_akhir_softcopy/<?= $row['nim'] ?>_tugas_akhir_softcopy.pdf"
                ...
                <div class="modal-body">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form id="verifikasiForm" action="buttonKonfirmasi/buttonsoftcopy.php" method="POST">
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function () {
            ...
            buttons.forEach(button => {
                button.addEventListener("click", function () {
                    const nim = this.getAttribute("data-nim");
                    const pdfUrl = `../Documents/uploads/tugas_akhir_softcopy/${nim}_tugas_akhir_softcopy.pdf`;

                    // Update isi modal
                    document.getElementById('nim').value = nim;
                    document.getElementById('namaBerkas').value = `${nim}_tugas_akhir_softcopy.pdf`;
