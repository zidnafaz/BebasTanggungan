...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active" id="nav-foto">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Data Verifikasi Bukti Upload Foto Ijazah</h1>
                            ...
                            <table class="table table-striped table-bordered" id="dataTable" width="100%"
                                ...
                                <tbody>
                                    ...
                                    try {
                                        ...
                                        $sql = "SELECT m.nim, m.nama_mahasiswa, pk.status_pengumpulan_foto_ijazah AS status
                                        ...
                                        $sql .= " ORDER BY 
                                                    CASE 
                                                        WHEN pk.status_pengumpulan_foto_ijazah = 'pending' THEN 1
                                                        WHEN pk.status_pengumpulan_foto_ijazah = 'ditolak' THEN 2
                                                        WHEN pk.status_pengumpulan_foto_ijazah = 'belum upload' THEN 3
                                                        WHEN pk.status_pengumpulan_foto_ijazah = 'terverifikasi' THEN 4
                                                        ELSE 5
                                                    END";
                ...
                <div class="modal-body">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form id="verifikasiForm" action="buttonKonfirmasi/buttonfoto.php" method="POST">
